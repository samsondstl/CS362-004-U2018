...
// DJS: Added Passing handPos To Function To Be Able To Discard
int adventurerCardEffect(struct gameState *state, int handPos) {
  ...
  // DJS: Added To Ensure Adventurer Discarded Once Played
  discardCard(handPos, currentPlayer, state, 0);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurerCardEffect(state, handPos); // DJS: Updated To Pass handPos To Function
...
{
  // DJS: Updated To Put Card In Played Pile When Trashed
  // DJS: Updated To Put Card In Discard Pile When Not Trashed
