...
int main()
{
   ...
   printf("CARD TEST 1: Draws Three Cards\n"); 
   cardEffect(smithy, 0, 0, 0, g, player1, 0);

   assertTrue(state.handCount[player1]    == prevState.handCount[player1]    + 2);
   assertTrue(state.deckCount[player1]    == prevState.deckCount[player1]    - 3);
